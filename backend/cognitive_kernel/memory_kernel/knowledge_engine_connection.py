...
class KnowledgeEngineConnection(object):
    ...
    @staticmethod
    def _generate_d_p_mapping_id(document_id, proposition_id):
        return (
            "DPM"
            + hashlib.md5(
    ...
    @staticmethod
    def _generate_p_c_mapping_id(proposition_id, concept_id):
        return (
            "DCM"
            + hashlib.md5(
    ...
    def _convert_d_p_mapping_to_row(self, document_id, proposition_id):
        row = OrderedDict(
            {
                "_id": self._generate_d_p_mapping_id(
    ...
    def _convert_p_c_mapping_to_row(self, proposition_id, concept_id):
        row = OrderedDict(
            {
                "_id": self._generate_p_c_mapping_id(
    ...
    def _convert_p_relation_to_row(
    ...
    def _convert_c_a_mapping_to_row(
        self, instantiation_concept_id, abstraction_concept_id, score
    ):
        row = OrderedDict(
            {
                "_id": self._generate_c_a_mapping_id(
                    instantiation_concept_id, abstraction_concept_id
                )
            }
        )
    ...
    def insert_d_p_mappings(self, document_proposition_mappings):
        ...
        rows = list(
            map(
                lambda x: self._convert_d_p_mapping_to_row(x[0], x[1]),
    ...
    def insert_proposition_concept_mappings(self, proposition_concept_mappings):
        ...
        rows = list(
            map(
                lambda x: self._convert_p_c_mapping_to_row(x[0], x[1]),
    ...
    def insert_proposition_relations(self, proposition_relations):
        ...
        rows = list(
            map(
                lambda x: self._convert_p_relation_to_row(x[0], x[1], x[2]),
    ...
    def insert_concept_abstract_mappings(self, concept_abstract_mappings):
        ...
        rows = list(
            map(
                lambda x: self._convert_c_a_mapping_to_row(
                    x[0], x[1], x[2]
                ),
    ...
    def retrieve_p_ids_by_concepts(self, concepts):
        ...
        raw_result = self._conn.get_rows_by_s_key_m_values(
    ...
    def retrieve_documents_by_propositions(self, propositions):
        ...
        return self.retrieve_d_by_proposition_ids(pids=pids)

    def retrieve_d_by_proposition_ids(self, pids):
    ...
    def retrieve_doc_content_based_on_p_ids(
    ...
    def retrieve_p_content_based_on_p_ids(self, pids):
        contents = []
        for pid in pids:
    ...
    def retrieve_d_content_based_on_d_ids(self, dids):
        doc_contents = []
        doc_metadata = []
        for did in dids:
